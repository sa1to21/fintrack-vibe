...
async def cmd_start(message: types.Message):
    ...
    tips_keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📤 Поделиться с друзьями", url="https://t.me/share/url?url=https://t.me/WiseTrackAppBot")],
        [InlineKeyboardButton(text="💬 Поддержка и вопросы", url="https://t.me/sa1to21")],
    ...
    await message.answer(
        ...
        "▸ 🤝 Поделись ботом с друзьями - вместе управлять финансами веселее!\n\n"

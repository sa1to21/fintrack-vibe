...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        ...
        "💰 Управление личными финансами прямо в Telegram!\n\n"
        "✨ Что умеет бот:\n"
        "• 📊 Учёт доходов и расходов\n"
        "• 💳 Управление счетами и картами\n"
        "• 📈 Детальная аналитика и статистика\n"
        "• 🏷️ Кастомизация категорий с emoji\n"
...
⚠️ Важно: Такие переводы учитываются в статистике расходов c категорией "Погашение задолженности"
""",
        "categories": """

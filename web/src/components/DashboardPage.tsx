...
export function DashboardPage({ onAddTransaction, onManageAccounts, onViewAllTransactions, onTransactionClick, onTransfer }: DashboardPageProps) {
  ...
  return (
    <div className="min-h-full" style={{ background: 'var(--bg-page-dashboard)' }}>
      {/* Header */}
      <OptimizedMotion className="px-4 pt-6 pb-3 relative overflow-hidden" style={{ background: 'var(--bg-header)' }}>
        ...
        <div className="max-w-md mx-auto relative">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <img src={currentLogo} alt="WiseTrack" className="w-10 h-10" />
              <h1 className="text-white font-medium">WiseTrack</h1>
            </div>

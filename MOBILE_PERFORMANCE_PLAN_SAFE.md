...
### Шаг 2.1: Создать утилиту-обёртку для безопасной миграции
...
### Шаг 2.2: Тестовая замена на ОДНОЙ странице
...
### Шаг 2.3: Замена в остальных страницах (ПО ОДНОЙ!)
...
**Итого Фаза 2:** 3-4 часа (но БЕЗОПАСНО!)

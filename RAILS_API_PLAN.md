...
- [ ] **2.1** Создать Rails API проект в папке `api/`
- [ ] **2.2** Настроить CORS для взаимодействия с фронтендом
- [ ] **2.3** Создать модели User, Account, Transaction, Category
- [ ] **2.4** Реализовать API endpoints с JSON serialization
- [ ] **2.5** Добавить аутентификацию (JWT)
